...
class Tool(benchexec.tools.template.BaseTool):
    """
    Tool info for test-suite validator (https://gitlab.com/sosy-lab/software/test-suite-validator
    """
    ...
    def executable(self):
        return util.find_executable(
            "testsuite-validator", "bin/testsuite-validator"
        )
